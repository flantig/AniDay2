...
export default abstract class buttons {
    public static getImageSet = async (day: string) => {
    ...
    public static sendMongoEntry = async (guildID: string, guildCurrentChannel: string) => {
        await mongoClient.connect();
        let result;
    ...
    public static removeMongoEntry = async (guildID: string) => {
        await mongoClient.connect();
        let botFeedback;
    ...
    public static dailyMongoSender = async () => {
        await mongoClient.connect();
